...
const About = () => {
  ...
  return (
    <div className="relative isolate bg-gray-900 m-auto w-[80%] h-[70%] flex place-items-center justify-center rounded-3xl overflow-hidden">
      <div className="mx-auto grid items-center max-w-7xl grid-cols-1 lg:grid-cols-2 overflow-auto scrollbar-thin scrollbar-track-gray-800/0 scrollbar-thumb-gray-900/0">
